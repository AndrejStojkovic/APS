...
// In the first line of the input, the number of nodes in the list is given, and then in the second line,
// the nodes of which it is composed are given. The output should print the nodes of the sorted list
